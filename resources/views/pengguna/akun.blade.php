...
<div class="container-xxl flex-grow-1 container-p-y">
  <div class="card mb-4">
    <form action="/perbaiki/<?php echo Crypt::encryptString(auth()->user()->id);?>" method="POST" enctype="multipart/form-data">
      @csrf
      @method('PUT')
    ...
    <hr class="my-0" />
      <div class="card-body">
        <div class="row">
          <div class="col mb-12">
                <label for="nameBasic" class="form-label">Jenis Pengguna</label>
                <h5 class="">{{ old('name', $user->level) }}</h5>
          </div>
        </div>
