    ...
    <div class="card page-panel">
      <div class="card-body py-4">
        <div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
            <div>
                <div class="text-muted small fw-light">Data / <span class="fw-semibold text-body">Indikator</span></div>
                <h4 class="mb-0 fw-bold">Daftar Indikator</h4>
            </div>
        ...
        <div class="pilar-tabs-container mb-4">
            <div class="pilar-tabs">
                ...
                @foreach($pilars as $p)
                    <a href="{{ route('target.index', ['pilar' => $p]) }}" 
        ...
        <div class="row g-3 align-items-center mb-4">
            ...
            <div class="col-md-6 d-flex align-items-center gap-3">
                <a href="{{ route('target.index') }}" class="btn btn-outline-secondary px-4 py-2" style="border-radius: 8px;">
                    <i class="bx bx-reset me-1"></i> Reset
                </a>
                <span class="text-muted small">Menampilkan {{ $targets->count() }} data</span>
            </div>
        </div>
          ...
          <table id="table" class="table table-striped table-bordered" style="width:100%">
            ...
            <tbody>
              ...
              <tr id="index_{{ $data->id }}">
                <td><span class="badge-pilar">{{ $data->tpb ? $data->tpb->pilar : '-' }}</span></td>
